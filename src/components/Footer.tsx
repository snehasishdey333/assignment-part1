  ...
  return (
    <footer className="bg-black text-white py-12 px-6 md:px-20">
      <div className='w-full flex flex-col md:flex-row items-center justify-between mb-4 md:mb-0'>
          <h2 className="text-2xl font-bold mb-4">SkillsCapital<span className="text-green-500">.</span></h2>
          <div className='flex-col md:flex items-center space-x-2'>
            <p>Follow our socials</p>
            <Image src="/Social Media Icon.png" alt="logo" height={100} width={100} className="" />
          </div>
        </div>
      ...
      <p className="text-center text-xs mt-10">Copyright © 2025 All Rights Reserved.</p>
    </footer>
  )
}
