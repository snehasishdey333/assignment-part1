...
const Expertise = () => {
  return (
    ...
    <h2 className="text-3xl md:text-5xl font-bold mb-2 text-black">Source & Deploy SAP Expertise Seamlessly</h2>
    <p className="text-gray-600 mb-10 mt-6">Our AI-driven platform powers three key engagement models</p>
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      {[
        ...
        <div key={title} className="bg-white rounded-xl shadow pb-6">
          ...
          <p className="px-4 text-sm text-left text-gray-600 mb-4">{desc}</p>
